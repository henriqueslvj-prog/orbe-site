...
export default function Page() {
  return (
    <div className="py-12 pb-16">
      ...
      <h1 className="mt-2 text-3xl sm:text-4xl font-light">Carteiras</h1>
      <p className="mt-3 text-white/60 max-w-2xl">Em breve. Por enquanto, monte sua Seleção com as pulseiras disponíveis.</p>
